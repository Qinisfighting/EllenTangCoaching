  ...
  return (
    <footer className="">
      ...
      <div className="text-center flex justify-center items-center">
        ...
        <Link to="/terms">
          <p className="px-2 border-x hover:text-myblue-400  py-0 text-sm">
            Terms of Service
          </p>
        </Link>
        <Link to="/practice">
      ...
      <a href="https://www.yanqin.de" target="_blank" rel="noreferrer">
        <h5 className="text-sm text-center bg-mystone-300 w-fit h-fit text-white  mx-auto my-4 rounded-full py-0 px-4 drop-shadow-md hover:translate-x-1">
          {" "}
          © {new Date().getFullYear()} by QIN&apos;s code
        </h5>
      </a>
    </footer>
  );
