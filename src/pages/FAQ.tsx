      ...
      <div className="w-screen">
        <div className="w-11/12 mx-auto xl:w-5/6">
          ...
          <div className="w-11/12 mx-auto lg:mb-10 pb-4">  
             ...
             <p>Our sessions are 100% confidential. I follow the Association for Coaching <a className="text-myblue-400 underline" href="https://www.associationforcoaching.com/page/AboutCodeEthics" target="_blank" >Global Code of Ethics</a>. You can also find the confidential provision in my <Link className="text-myblue-400 underline" to="practice">Practice Policy</Link> here.</p>
             ...
             <p>Yes, I speak native Mandarin and can certainly do so if preferred. See my <Link to="/cn" className="text-myblue-400 underline">中文心理咨询</Link> page for more details.</p>
          </div>
        </div>
