      ...
      <div className="w-screen">
        <div className="w-11/12 mx-auto xl:w-5/6">
          ...
          <details className="py-4">
             <summary className="text-2xl font-semibold">What is life coaching?</summary>   
          ...
          <details className="py-4">
             <summary className="text-2xl font-semibold">How is life coaching different from talking to a friend?</summary>   
          ...
          <details className="py-4">
             <summary className="text-2xl font-semibold">What are you like as a coach?</summary>
          ...
          <details className="py-4">
             <summary className="text-2xl font-semibold">Why did you become a life coach?</summary>   
          ...
          <details className="py-4">
             <summary className="text-2xl font-semibold">What is your coaching style?</summary>   
          ...
          <details className="py-4">
             <summary className="text-2xl font-semibold">What types of coaching do you offer?</summary>
          ...
          <details className="py-4">
             <summary className="text-2xl font-semibold">How does the process work?</summary>   
          ...
          <details className="py-4">
             <summary className="text-2xl font-semibold">Do you offer coaching face-to-face or online?</summary>
          ...
          <details className="py-4">
             <summary className="text-2xl font-semibold">Does online life coaching work?</summary>   
          ...
          <details className="py-4">
             <summary className="text-2xl font-semibold">How often do we meet?</summary>   
          ...
          <details className="py-4">
             <summary className="text-2xl font-semibold">How much do you charge?</summary>   
          ...
          <details className="py-4">
             <summary className="text-2xl font-semibold">How long does the coaching process take?</summary>   
          ...
          <details className="py-4">
             <summary className="text-2xl font-semibold">What is your cancellation policy?</summary>  
          ...
          <details className="py-4">
             <summary className="text-2xl font-semibold">What areas of my life can I seek your coaching for?</summary>   
          ...
          <details className="py-4">
             <summary className="text-2xl font-semibold">Can I talk about very personal or private issues with you?</summary>  
          ...
          <details className="py-4">
             <summary className="text-2xl font-semibold">Do you focus on the past or the future?</summary>   
          ...
          <details className="py-4">
             <summary className="text-2xl font-semibold">What types of clients do you take on?</summary>  
          ...
          <details className="py-4">
             <summary className="text-2xl font-semibold">Do you provide coaching in languages other than English?</summary>   
