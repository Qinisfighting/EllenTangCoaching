  ...
  return (
    <div className="mx-auto my-20 px-6 text-justify w-11/12 text-curiousBlue-900">
      ...
      <p>
        ...
        website (taken together, the Website). The Website is owned and operated
        by Ellen Lei Tang (“Ellen Tang”). The Website is offered subject to your
        ...
        Ellen Tang (collectively, the “Agreement”).
      </p>
      ...
      <p>
        ...
        conditions are considered an offer by Ellen Tang, acceptance is
      ...
      <p>
        ...
        others, and Ellen Tang may change or remove any description or keyword
        that it considers inappropriate or unlawful, or otherwise likely to
        cause Ellen Tang liability. You must immediately notify Ellen Tang of
        any unauthorised uses of your blog, your account or any other breaches
        of security. Ellen Tang will not be liable for any acts or omissions by
      ...
      <p>
        ...
        company other than your own; and you have, in the case of Content that
        ...
        so by Ellen Tang or otherwise.
      </p>
      <p>
        By submitting Content to Ellen Tang for inclusion on your Website, you
        grant Ellen Tang a world-wide, royalty-free, and non-exclusive license
        ...
        delete Content, Ellen Tang will use reasonable efforts to remove it from
        the Website, but you acknowledge that caching or references to the
        Content may not be made immediately unavailable.
      </p>

      <p>
        Without limiting any of those representations or warranties, Ellen Tang
        has the right (though not the obligation) to, in Ellen Tang’s sole
        discretion (i) refuse or remove any content that, in Ellen Tang’s
        reasonable opinion, violates any Ellen Tang policy or is in any way
        harmful or objectionable, or (ii) terminate or deny access to and use of
        the Website to any individual or entity for any reason, in Ellen Tang’s
        sole discretion. Ellen Tang will have no obligation to provide a refund
      ...
      <h3>General Terms.</h3>
      <p>
        By selecting a product or service, you agree to pay Ellen Tang the
      ...
      <p>
        Unless you notify Ellen Tang before the end of the applicable
        ...
        any time by submitting your request to Ellen Tang in writing.
      </p>
      <h3>Services.</h3>
      <p>
        Fees; Payment. By signing up for a Services account you agree to pay
        Ellen Tang the applicable setup fees and recurring fees. Applicable fees
        will be invoiced starting from the day your services are established and
        in advance of using such services. Ellen Tang reserves the right to
        change the payment terms and fees upon thirty (30) days prior written
        notice to you. Services can be canceled by you at anytime on thirty (30)
        days written notice to Ellen Tang.
      </p>
      <h3>Support. </h3>
      <p>
        ...
        assistance by email at any time (with reasonable efforts by Ellen Tang
        ...
        services. All support will be provided in accordance with Ellen Tang
        standard services practices, procedures and policies.
      </p>
      <h3>Responsibility of Website Visitors.</h3>
      <p>
        Ellen Tang has not reviewed, and cannot review, all of the material,
        ...
        the Website, Ellen Tang does not represent or imply that it endorses the
        ...
        and conditions, stated or unstated. Ellen Tang disclaims any
        ...
        posted. Content Posted on Other Websites. We have not reviewed, and
        ...
        . Ellen Tang does not have any control over those non-Ellen Tang
        websites and webpages, and is not responsible for their contents or
        their use. By linking to a non-Ellen Tang website or webpage, Ellen Tang
        ...
        and other harmful or destructive content. Ellen Tang disclaims any
        responsibility for any harm resulting from your use of non-Ellen Tang
        websites and webpages.
      </p>
      <h3> Copyright Infringement and DMCA Policy. </h3>
      <p>
        As Ellen Tang asks others to respect its intellectual property rights,
        ...
        violates your copyright, you are encouraged to notify Ellen Tang in
        accordance with Ellen Tang’s Digital Millennium Copyright Act (“DMCA”)
        Policy. Ellen Tang will respond to all such notices, including as
        required or appropriate by removing the infringing material or disabling
        all links to the infringing material. Ellen Tang will terminate a
        ...
        copyrights or other intellectual property rights of Ellen Tang or
        others. In the case of such termination, Ellen Tang will have no
        obligation to provide a refund of any amounts previously paid to Ellen
        Tang.
      </p>
      <h3>Intellectual Property.</h3>
      <p>
        This Agreement does not transfer from Ellen Tang to you any Ellen Tang
        or third party intellectual property, and all right, title and interest
        ...
        , or the Website are trademarks or registered trademarks of Ellen Tang
        or Ellen Tang’s licensors. Other trademarks, service marks, graphics and
        logos used in connection with the Website may be the trademarks of other
        third parties. Your use of the Website grants you no right or license to
        reproduce or otherwise use any Ellen Tang or third-party trademarks.
      </p>
      <h3>Advertisements. </h3>
      <p>
        Ellen Tang reserves the right to display advertisements on your blog
      ...
      <h3>Changes. </h3>
      <p>
        Ellen Tang reserves the right, at its sole discretion, to modify or
        ...
        constitutes acceptance of those changes. Ellen Tang may also, in the
      ...
      <h3>Termination. </h3>
      <p>
        Ellen Tang may terminate your access to all or any part of the Website
        ...
        account can only be terminated by Ellen Tang if you materially breach
        this Agreement and fail to cure such breach within thirty (30) days from
        Ellen Tang’s notice to you thereof; provided that, Ellen Tang can
      ...
      <p>
        The Website is provided “as is”. Ellen Tang and its suppliers and
        licensors hereby disclaim all warranties of any kind, express or
        implied, including, without limitation, the warranties of
        merchantability, fitness for a particular purpose and non-infringement.
        Neither Ellen Tang nor its suppliers and licensors, makes any warranty
      ...
      <p>
        In no event will Ellen Tang, or its suppliers or licensors, be liable
        ...
        exceed the fees paid by you to Ellen Tang under this agreement during
        the twelve (12) month period prior to the cause of action. Ellen Tang
      ...
      <p>
        ...
        strict accordance with the Ellen Tang Privacy Policy, with this
      ...
      <p>
        You agree to indemnify and hold harmless Ellen Tang, its contractors,
      ...
      <h3>Miscellaneous. </h3>
      <p>
        This Agreement constitutes the entire agreement between Ellen Tang and
        you concerning the subject matter hereof, and they may only be modified
        by a written amendment signed by an authorized executive of Ellen Tang,
        or by the posting by Ellen Tang of a revised version. Except to the
        extent applicable law, if any, provides otherwise, this Agreement, any
        access to or use of the Website will be governed by the laws of the UK,
        ...
        and federal courts located in London. Except for claims for injunctive
        ...
        place in London, UK, in the English language and the arbitral decision
        ...
        agrees to be bound by, its terms and conditions; Ellen Tang may assign
