...
import likesimg from '../assets/likesimg.png';
...
function Articles() {
   ...
   function renderArticles(articles: Article[]) {
       ...
       const displayedCatalog = catalogFilter
                   ...
                   : articles                  
               const articlesElements = displayedCatalog.map(({id, title, imageUrl, createdOn, catalog, comments, likes}) => {               
                   return (
                     ...
                     <div className={`w-full ${((user as { email: string })?.email === "ellen.ltang@gmail.com") ? "min-h-72" : "min-h-52"} flex flex-col items-start justify-between`}>
                         <div>
                        ...
                        { 
                           (user as { email: string })?.email === "ellen.ltang@gmail.com" && 
       ...
       <div className="w-screen">
           <div className="mx-auto px-6 pt-16 pb-10 text-center flex justify-center items-center">
               <div className="text-mystone-700 p-0 flex flex-col justify-center items-center gap-4">
                  ...
                  {(user as { email: string })?.email==="ellen.ltang@gmail.com"&&<Link to="/blog/add"><button className="text-5xl font-thin text-mystone-400">+</button></Link>}
               </div>                 
           </div>
      ...
      <div className="w-screen">   
        ...
        <div className="w-11/12 xl:w-2/3 mx-auto my-4 border-y mb-40">
          <div className="my-10 flex flex-col justify-start items-center lg:gap-16 lg:flex-row lg:justify-between">
             ...
             <a className="text-myblue-400 underline w-11/12 lg:w-auto" href="https://community.thriveglobal.com/how-to-make-a-successful-career-change-by-leveraging-your-existing-skills-and-experiences/" target="_blank" rel="noreferrer"><p>How To Make A Successful Career Change By Leveraging Your Existing Skills And Experiences</p></a>
          </div>
          <div className="my-10 flex flex-col justify-start items-center lg:gap-16 lg:flex-row lg:justify-between">
             <img src={outwittrade} className="w-3/4 lg:w-1/4 p-4" />
             <a className="text-myblue-400 underline w-11/12 lg:w-auto" href="https://outwittrade.com/how-to-deal-with-conflict-in-the-workplace/#ellen" target="_blank" rel="noreferrer"><p>How To Deal With Conflict In The Workplace: Experts Comment</p></a>
          </div>
          <div className="my-10 flex flex-col justify-start items-center lg:gap-16 lg:flex-row lg:justify-between">
             <img src={upjourney} className="w-3/4 lg:w-1/4 p-4" />
             <a className="text-myblue-400 underline w-11/12 lg:w-auto" href="https://upjourney.com/how-to-help-a-friend-deal-with-a-breakup" target="_blank" rel="noreferrer"><p>How to Help a Friend Deal With a Breakup</p></a>
          </div>
          <div className="my-10 flex flex-col justify-center items-center lg:gap-16 lg:flex-row lg:justify-between lg:items-start">
             ...
             <div className="flex flex-col justify-center items-center lg:items-end gap-4">
                 <a className="text-myblue-400 underline w-11/12 lg:w-auto" href="https://www.godates.co/relationships/steps-to-codependency-recovery/" target="_blank" rel="noreferrer"><p>12 Steps To Codependency Recovery</p></a>
                 <a className="text-myblue-400 underline w-11/12 lg:w-auto" href="https://www.godates.co/relationships/how-to-be-more-vulnerable-in-a-relationship/" target="_blank" rel="noreferrer"><p>How To Be More Vulnerable In A Relationship: 7 Steps</p></a>
                 <a className="text-myblue-400 underline w-11/12 lg:w-auto" href="https://www.godates.co/life/how-to-forgive-yourself-for-cheating/" target="_blank" rel="noreferrer"><p>How To Forgive Yourself For Cheating</p></a>
                 <a className="text-myblue-400 underline w-11/12 lg:w-auto" href="https://www.godates.co/heartbreak/how-to-cure-oneitis/" target="_blank" rel="noreferrer"><p>How to Cure Oneitis: Things That Pickup Artists Won’t Tell You</p></a>
             </div>
