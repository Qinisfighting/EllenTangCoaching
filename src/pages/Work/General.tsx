        ...
        <div className="w-11/12 lg:w-3/4 mx-auto mb-36 flex flex-col gap-8">
            ...
            <div className="mx-auto flex flex-col justify-between items-top gap-4 lg:gap-8 lg:flex-row">             
              <div className="order-2 lg:order-1 lg:w-2/3 w-11/12 mx-auto">
                ...
                <p className="text-xl">I assign no blame or judgement on any human behaviours and desires. Anything that you feel is significant can be explored with complete confidentiality and acceptance from me. I know this quality can only be demonstrated, not told. So if we haven’t met before, please feel free to take up my offer of a <Link to="/about" className="underline text-myblue-400">discovery session</Link> and decide whether you could trust me.</p>
            ...
            <div className="mx-auto flex flex-col justify-between items-top gap-4 lg:gap-8 lg:flex-row ">             
              <div className="order-2 lg:order-1 lg:w-2/3 w-11/12 mx-auto">
                ...
                <p className="text-xl">When you feel ready to form such a partnership with me, I will be delighted to hear from you.</p>
                <Link to="/work/booking"><button className="btn-next float-left my-12 lg:my-16 text-md ">Book Your Discovery Session ➣</button></Link>
              </div> 
