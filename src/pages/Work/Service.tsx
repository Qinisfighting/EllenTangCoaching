  ...
  return (
    <div className="w-full">
        ...
        <div  className="w-5/6 mx-auto lg:mb-10 pb-4">  
          <p className="md:text-xl">50 mins per session. Appointments outside these hours may be available. Please <Link to="/contact" className="underline text-myblue-400">contact me</Link> directly. Online appointments are available on Skype, Zoom or over the phone. Face-to-face appointments are available in London (UK).</p>
          <p className="md:text-xl">The relationship between you and me is key to the effectiveness of life coaching. So before you invest for the long term, you can take advantage of the  <Link to="/work/booking" className="underline text-myblue-400">discovery session</Link> to find out more about me.</p>
          <p className="md:text-xl">See <Link to="/work/pricing" className="underline text-myblue-400">Pricing</Link> and <Link to="/faq" className="underline text-myblue-400">FAQ</Link> pages for more details.</p>
        ...
        <div className="w-5/6  mx-auto flex flex-col gap-10 mb-20 justify-center items-center xl:flex-row xl:justify-between xl:items-start ">
           ...
           <div className="w-full xl:w-1/3">
              ...
              <p className="md:text-xl">Money isn’t everything. But not having enough money is like a toothache – it becomes all that you can think about. To live a financially abundant life means freeing up emotional and intellectual resources for higher levels of fulfilment.</p>
              <p className="md:text-xl">My experience has taught me that living life as an investor is so powerful and expansive that I would never wish to return to the life of a ‘spender’ or a ‘saver.’ The shift of a mindset is what underlies shifts of all other aspects of life. Viewing life from the perspective of an investor, you become:</p>
               <ul className="list-disc list-inside">
