  ...
  return (
    <div className="w-full">
        ...
        <div  className="flex flex-col justify-between items-center w-5/6 lg:w-2/3 mx-auto lg:mt-8 pb-4"> 
           ...
           <Link to="/cn/wenti"><button className="btn-next  mt-12 mb-2 lg:mt-16 text-md w-32">常见问题 ➣</button></Link>
        </div>
        ...
        <div className="mx-auto w-5/6 my-21">
           ...
           <div className="w-full lg:w-1/2">
              ...
              <div className=''>
                ...
                <p className='border border-myblue-100 text-xs px-4'>*包含场地租借费用</p> 
                <Link to="/cn/yuyue"><button className="btn-next  mt-12 mb-2 lg:mt-16 text-md w-32">预约咨询 ➣</button></Link>          
              </div> 
           </div>                      
        </div>
        <div className="w-full lg:w-1/2">
