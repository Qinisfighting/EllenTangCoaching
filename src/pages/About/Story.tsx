      ...
      <div className="w-4/5 mx-auto xl:w-2/3 my-20">       
           ...
           <div>
               ...
               <div className="flex flex-col xl:inline">  
                  <img src={growth} alt="growth" className="w-full my-8 object-cover xl:w-2/5 xl:mr-8 xl:my-3 shadow-lg xl:float-left" />    
               ...
               <div className="flex flex-col xl:inline">  
                  <img src={discovery} alt="discovery" className="w-full my-8 object-cover xl:w-2/5 xl:ml-8 xl:my-3 shadow-lg xl:float-right" />    
                  <div className="text-lg xl:text-xl">
                     <p>
