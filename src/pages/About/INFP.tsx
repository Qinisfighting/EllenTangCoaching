    ...
    return (
      <div className='w-5/6 mt-6 mx-auto flex flex-col md:flex-row lg:w-4/5 md:items-start md:mt-16 mb-28'>
        <div className='md:pr-4 xl:pr-12'>
          ...
          <p className='text-center'>Credit: <a className='text-myblue-400 underline'>16 Personalities</a></p>
          <img className="mx-auto mt-8 mb-4 md:my-8 w-full "  src={infp}/>  
          <h2 className='text-3xl md:text-4xl'>Introduction</h2>
          <div>
             <p className="md:text-xl">INFP personalities are true idealists, always looking for the hint of good in even the worst of people and events, searching for ways to make things better. While they may be perceived as calm, reserved, or even shy, INFPs have an inner flame and passion that can truly shine. Comprising just 4% of the population, the risk of feeling misunderstood is unfortunately high for the INFP personality type – but when they find like-minded people to spend their time with, the harmony they feel will be a fountain of joy and inspiration.</p>
             <p className="md:text-xl">Being a part of the Diplomat Role group, INFPs are guided by their principles, rather than by logic (Analysts), excitement (Explorers), or practicality (Sentinels). When deciding how to move forward, they will look to honor, beauty, morality and virtue – INFPs are led by the purity of their intent, not rewards and punishments. People who share the INFP personality type are proud of this quality, and rightly so, but not everyone understands the drive behind these feelings, and it can lead to isolation.</p>     
             <p className="md:text-xl">All that is gold does not glitter; not all those who wander are lost; the old that is strong does not wither; deep roots are not reached by the frost.J. R. R. TOLKIEN</p>
             <br/>
             <img src={infp3} className="mx-auto my-4 md:w-1/2 md:float-left md:pr-6 md:mt-6"/>
          </div>
          <br/>
          <h2 className='text-3xl md:text-4xl'>We Know What We Are, but Know Not What We May Be</h2>
