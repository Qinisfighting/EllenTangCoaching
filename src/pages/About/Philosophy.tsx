  ...
  return (
    ...
    <div className="w-4/5 mx-auto xl:w-2/3 my-20">
         <div className="">
            ...
            <br/>
            <p>I have carefully designed my logo to represent the values I see as important. The circles symbolise harmony and peace in one’s heart, mind and body. The multiple layers stand for the depth of an individual, as well as the progress that can be made as we look through each layer. The white stripe represents the path you and I will co-create towards discovery, growth and fulfilment. The circles are coloured in blue which represents openness, freedom, intuition, imagination, expansiveness, inspiration, and sensitivity, as well as meanings of depth, trust, loyalty, sincerity, wisdom, confidence, stability, and intelligence. I wish to incorporate all these qualities into my coaching relationship with you, so that you can reach deep understanding of yourself and actualise your full potential.</p>
            <img src={philo3} alt="philo3" className="md:w-1/3 object-cover float-right md:pl-4 py-4"/> 
            <br/>
            <p>Each individual is unique and therefore requires coaching completely tailored to their individuality. There is no such thing as a ‘one-size-fits-all’ programme when it comes to self actualisation. I offer a free initial consultation as an opportunity for you and me to learn about each other’s uniqueness and assess how a coaching relationship between us, two unique individuals, will be valuable and empowering to you. If after the consultation, or at any point during our journey, you decide that I am not the right coach for you, you can walk away or stop coaching with me at your discretion. You will not be asked to commit to a minimum number of sessions. Sessions can be booked individually or on a monthly basis (see my Pricing page for detail).</p>          
            <br/>
            <p>I believe that real personal growth leads to long-term, sustainable happiness and fulfilment, and is much more important than finding short-term solutions alone. I am here to build genuine, lasting trust and connection with you so that your mind is freed up from the confusing relational dynamics that frequently arise in life and often cloud our vision and judgment. You can think of me as a playmate who constantly wants to know you better, brings you tools that may be helpful, and cheers you on as you take on each adventure, big or small.</p>         
            <br/>
            <p>I encourage all my clients to begin their journey of growth by taking a personality test, one with a good scientific basis, and share the results with me if they wish to. You can also check out my results here and read my personal journey here.</p>         
            <br/>
